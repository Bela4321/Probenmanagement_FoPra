...
public class SampleManagementApplication {
	...
	public CommandLineRunner demo(StudyRepository studyRepository,
		...
		return (args) -> {
			...
			study1.setEndDate(new Date());
			study1.setSponsor("Virologie");
			study1.setSender1("John");
			study1.setSender2("Robert");
			study1.setSender3("Peter");
			study1.setExpectedNumberOfSubjects("100");
			study1.setExpectedNumberOfSampeDeliveries("50");
			study1.setRemark("From Marburg");
			Study study2 = new Study();
			study2.setStudyName("Sample Study 2");
			study2.setStartDate(new Date());
			study2.setEndDate(new Date());
			study2.setSponsor("Medizin");
			study2.setSender1("Alex");
			study2.setSender2("Johnny");
			study2.setSender3("Chris");
			study2.setExpectedNumberOfSubjects("10");
			study2.setExpectedNumberOfSampeDeliveries("5");
			study2.setRemark("From Giessen");
			Study study3 = new Study();
			study3.setStudyName("Sample Study 3");
			study3.setStartDate(new Date());
			study3.setEndDate(new Date());
			study3.setSponsor("Informatik");
			study3.setSender1("Maria");
			study3.setSender2("Natasha");
			study3.setSender3("Adam");
			study3.setExpectedNumberOfSubjects("15");
			study3.setExpectedNumberOfSampeDeliveries("20");
			study3.setRemark("From Ginseldorf");
